...
{  
		...
		icm20602_get_accel(icm20602_accel);
		icm20602_temp=icm20602_get_temp();
	OLED_ShowSignedNum(3, 1, icm20602_accel[0], 2);
	OLED_ShowSignedNum(3, 5, icm20602_accel[1], 2);
	OLED_ShowSignedNum(3, 9, icm20602_accel[2], 2);
	
//	OLED_ShowSignedNum(1, 9, icm20602_temp, 2);
}

void icm20602_test3(void)
{  
		float icm20602_temp;
		icm20602_temp=icm20602_get_temp();
	  OLED_ShowSignedNum(3, 1, icm20602_temp, 2);
}
